...
<div class="container-sm">
    <div class="row justify-content-center">
        ...
        <div class="col-md-auto">
            <form action = "location.php" method = "post">
                <button type="submit"  class="btn btn-primary font-size" name='d_id' value="00000000000100000000000000"><span>皮膚科</span></button>
        ...
        <div class="col-md-auto">
            <form action = "location.php" method = "post">
                <button type="submit"  class="btn btn-primary font-size" name='d_id' value="00000000000010000000000000"><span>精神科</span></button>
